# Pyroscope Docker Hardened Image Guide
...
Run the following commands. Replace `<your-namespace>` with your organization's namespace and `<tag>` with the image variant you want to run.
...
Start Pyroscope as a standalone profiling server:
...
$ curl http://localhost:4040/metrics | head -50
...
5. **Set up visualization**
   ...
   Since the DHI image doesn't include the web UI, configure Grafana with the Pyroscope data source to visualize profiling data.
